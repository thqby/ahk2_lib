...
class ID2D1Factory extends ID2DBase {
	...
	ReloadSystemMetrics() => ComCall(3, this)
	...
	GetDesktopDpi(&dpiX, &dpiY) => ComCall(4, this, 'float*', &dpiX := 0, 'float*', &dpiY := 0, 'int')
	...
	;
	; ID2D1Geometry , D2D1_MATRIX_3X2_F
	...
	;
	; D2D1_DRAWING_STATE_DESCRIPTION , IDWriteRenderingParams ,
	...
	;
	; IWICBitmap , D2D1_RENDER_TARGET_PROPERTIES
	 ...
	 *
	 * IDXGISurface , D2D1_RENDER_TARGET_PROPERTIES
	 */
...
class ID2D1RenderTarget extends ID2D1Resource {
	...
	;
	; D2D1_SIZE_U, ptr, uint, D2D1_BITMAP_PROPERTIES
	...
	;
	; ID2D1Bitmap , D2D1_BITMAP_BRUSH_PROPERTIES , D2D1_BRUSH_PROPERTIES
	CreateBitmapBrush(bitmap, bitmapBrushProperties := 0, brushProperties := 0) {
	...
	;
	; D2D1_COLOR_F , D2D1_BRUSH_PROPERTIES
	...
	;
	; D2D1_GRADIENT_STOP , D2D1_GAMMA , D2D1_EXTEND_MODE
	...
	;
	; D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES , D2D1_BRUSH_PROPERTIES , ID2D1GradientStopCollection
	...
	;
	; D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES , D2D1_BRUSH_PROPERTIES , ID2D1GradientStopCollection
	 ...
	 *
	 * D2D1_SIZE_F , D2D1_SIZE_U , D2D1_PIXEL_FORMAT , D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS
	 */
	...
	;
	; D2D1_POINT_2F, D2D1_POINT_2F, ID2D1Brush, ID2D1StrokeStyle
	DrawLine(point0, point1, brush, strokeWidth, strokeStyle) => ComCall(15, this, 'int64', NumGet(point0, 'int64'), 'int64', NumGet(point1, 'int64'), 'ptr', brush, 'float', strokeWidth, 'ptr', strokeStyle, 'int')

	; Draws the outline of a rectangle that has the specified dimensions and stroke style.
	;
	; D2D1_RECT_F , ID2D1Brush , ID2D1StrokeStyle
	DrawRectangle(rect, brush, strokeWidth, strokeStyle) => ComCall(16, this, 'ptr', rect, 'ptr', brush, 'float', strokeWidth, 'ptr', strokeStyle, 'int')

	; Paints the interior of the specified rectangle.
	;
	; D2D1_RECT_F , ID2D1Brush
	FillRectangle(rect, brush) => ComCall(17, this, 'ptr', rect, 'ptr', brush, 'int')

	; Draws the outline of the specified rounded rectangle using the specified stroke style.
	;
	; D2D1_ROUNDED_RECT , ID2D1Brush , ID2D1StrokeStyle
	DrawRoundedRectangle(roundedRect, brush, strokeWidth, strokeStyle) => ComCall(18, this, 'ptr', roundedRect, 'ptr', brush, 'float', strokeWidth, 'ptr', strokeStyle, 'int')
	...
	;
	; D2D1_ROUNDED_RECT , ID2D1Brush
	FillRoundedRectangle(roundedRect, brush) => ComCall(19, this, 'ptr', roundedRect, 'ptr', brush, 'int')

	; Draws the outline of the specified ellipse using the specified stroke style.
	;
	; D2D1_ELLIPSE , ID2D1Brush , ID2D1StrokeStyle
	DrawEllipse(ellipse, brush, strokeWidth, strokeStyle) => ComCall(20, this, 'ptr', ellipse, 'ptr', brush, 'float', strokeWidth, 'ptr', strokeStyle, 'int')

	; Paints the interior of the specified ellipse.
	;
	; D2D1_ELLIPSE , ID2D1Brush
	FillEllipse(ellipse, brush) => ComCall(21, this, 'ptr', ellipse, 'ptr', brush, 'int')

	; Draws the outline of the specified geometry using the specified stroke style.
	;
	; ID2D1Geometry , ID2D1Brush , ID2D1StrokeStyle
	DrawGeometry(geometry, brush, strokeWidth, strokeStyle) => ComCall(22, this, 'ptr', geometry, 'ptr', brush, 'float', strokeWidth, 'ptr', strokeStyle, 'int')
	...
	;
	; ID2D1Geometry , ID2D1Brush
	FillGeometry(geometry, brush, opacityBrush := 0) => ComCall(23, this, 'ptr', geometry, 'ptr', brush, 'ptr', opacityBrush, 'int')
	...
	;
	; ID2D1Mesh , ID2D1Brush
	FillMesh(mesh, brush) => ComCall(24, this, 'ptr', mesh, 'ptr', brush, 'int')
	...
	;
	; ID2D1Bitmap , ID2D1Brush , D2D1_OPACITY_MASK_CONTENT , D2D1_RECT_F
	FillOpacityMask(opacityMask, brush, content, destinationRectangle := 0, sourceRectangle := 0) => ComCall(25, this, 'ptr', opacityMask, 'ptr', brush, 'int', content, 'ptr', destinationRectangle, 'ptr', sourceRectangle, 'int')

	; Draws the specified bitmap after scaling it to the size of the specified rectangle.
	;
	; ID2D1Bitmap , D2D1_RECT_F , D2D1_BITMAP_INTERPOLATION_MODE , D2D1_RECT_F
	DrawBitmap(bitmap, destinationRectangle := 0, opacity := 1, interpolationMode := 1, sourceRectangle := 0) => ComCall(26, this, 'ptr', bitmap, 'ptr', destinationRectangle, 'float', opacity, 'uint', interpolationMode, 'ptr', sourceRectangle, 'int')
	...
	;
	; IDWriteTextFormat , D2D1_RECT_F , ID2D1Brush , D2D1_DRAW_TEXT_OPTIONS , DWRITE_MEASURING_MODE
	DrawText(string, textFormat, layoutRect, defaultForegroundBrush, options := 0, measuringMode := 0) => ComCall(27, this, 'str', string, 'uint', StrLen(string), 'ptr', textFormat, 'ptr', layoutRect, 'ptr', defaultForegroundBrush, 'int', options, 'int', measuringMode, 'int')
	...
	;
	; D2D1_POINT_2F , IDWriteTextLayout , ID2D1Brush , D2D1_DRAW_TEXT_OPTIONS
	DrawTextLayout(origin, textLayout, defaultForegroundBrush, options := 0) => ComCall(28, this, 'int64', NumGet(origin, 'int64'), 'ptr', textLayout, 'ptr', defaultForegroundBrush, 'uint', options, 'int')

	; Draws the specified glyphs.
	;
	; D2D1_POINT_2F , DWRITE_GLYPH_RUN , ID2D1Brush , DWRITE_MEASURING_MODE
	DrawGlyphRun(baselineOrigin, glyphRun, foregroundBrush, measuringMode := 0) => ComCall(29, this, 'int64', NumGet(baselineOrigin, 'int64'), 'ptr', glyphRun, 'ptr', foregroundBrush, 'int', measuringMode, 'int')
	...
	GetTransform() {
		ComCall(31, this, 'ptr', transform := D2D1_MATRIX_3X2_F(), 'int')
		return transform
	}
	...
	;
	; D2D1_ANTIALIAS_MODE
	GetAntialiasMode() => ComCall(33, this, 'int')
	...
	;
	; D2D1_TEXT_ANTIALIAS_MODE
	GetTextAntialiasMode() => ComCall(35, this, 'int')
	...
	SetTextRenderingParams(textRenderingParams := 0) => ComCall(36, this, 'ptr', textRenderingParams, 'int')
	...
	;
	; D2D1_TAG
	SetTags(tag1, tag2) => ComCall(38, this, 'uint64', tag1, 'uint64', tag2, 'int')

	; Gets the label for subsequent drawing operations.
	; If the same address is passed for both parameters, both parameters receive the value of the second tag.
	GetTags(&tag1, &tag2) => ComCall(39, this, 'uint64*', &tag1 := 0, 'uint64*', &tag2 := 0, 'int')
	...
	;
	; D2D1_LAYER_PARAMETERS , ID2D1Layer
	PushLayer(layerParameters, layer) => ComCall(40, this, 'ptr', layerParameters, 'ptr', layer, 'int')
	...
	Flush(&tag1 := 0, &tag2 := 0) => ComCall(42, this, 'uint64*', &tag1 := 0, 'uint64*', &tag2 := 0)

	; Saves the current drawing state to the specified ID2D1DrawingStateBlock.
	;
	; ID2D1DrawingStateBlock
	SaveDrawingState(drawingStateBlock) => ComCall(43, this, 'ptr', drawingStateBlock, 'int')

	; Sets the render target's drawing state to that of the specified ID2D1DrawingStateBlock.
	;
	; ID2D1DrawingStateBlock
	RestoreDrawingState(drawingStateBlock) => ComCall(44, this, 'ptr', drawingStateBlock, 'int')
	...
	;
	; D2D1_RECT_F , D2D1_ANTIALIAS_MODE
	PushAxisAlignedClip(clipRect, antialiasMode) => ComCall(45, this, 'ptr', clipRect, 'uint', antialiasMode, 'int')
	...
	PopAxisAlignedClip() => ComCall(46, this, 'int')
	...
	;
	; D2D1_COLOR_F
	Clear(clearColor := 0) => ComCall(47, this, 'ptr', clearColor, 'int')
	...
	EndDraw(&tag1 := 0, &tag2 := 0) => ComCall(49, this, 'uint64*', &tag1 := 0, 'uint64*', &tag2 := 0)
	...
	GetDpi(&dpiX, &dpiY) => ComCall(52, this, 'float*', &dpiX := 0, 'float*', &dpiY := 0, 'int')

	; Returns the size of the render target in device-independent pixels.
	GetSize() {
		ComCall(53, this, 'ptr', size := D2D1_SIZE_F(), 'int')
		return size
	}

	; Returns the size of the render target in device pixels.
	GetPixelSize() {
		ComCall(54, this, 'ptr', size := D2D1_SIZE_U(), 'int')
		return size
	}
	...
	GetMaximumBitmapSize() => ComCall(55, this, 'uint')
	...
	;
	; D2D1_RENDER_TARGET_PROPERTIES
	IsSupported(renderTargetProperties) => ComCall(56, this, 'ptr', renderTargetProperties, 'int')
}
...
class ID2D1HwndRenderTarget extends ID2D1RenderTarget {
	...
	;
	; D2D1_WINDOW_STATE
	CheckWindowState() => ComCall(57, this, 'int')
	...
	;
	; D2D1_SIZE_U
	Resize(pixelSize) => ComCall(58, this, 'ptr', pixelSize)

	; Returns the HWND associated with this render target.
	GetHwnd() => ComCall(59, this, 'ptr')
}
class ID2D1Image extends ID2D1Resource {
	static IID := '{65019f75-8da2-497c-b32c-dfa34e48ede6}'
}
class ID2D1DCRenderTarget extends ID2D1RenderTarget {
	...
	;
	; RECT
	BindDC(hDC, pSubRect) => ComCall(57, this, 'ptr', hDC, 'ptr', pSubRect)
}
class ID2D1Brush extends ID2D1Resource {
	...
	;
	; range 0–1
	SetOpacity(opacity) => ComCall(4, this, 'float', opacity, 'int')

	; Sets the transformation applied to the brush.
	;
	; D2D1_MATRIX_3X2_F
	SetTransform(transform) => ComCall(5, this, 'ptr', transform, 'int')

	; Gets the degree of opacity of this brush.
	GetOpacity() => ComCall(6, this, 'float')
...
class ID2D1BitmapBrush extends ID2D1Brush {
	...
	;
	; D2D1_EXTEND_MODE
	SetExtendModeX(extendModeX) => ComCall(8, this, 'int', extendModeX, 'int')

	; Specifies how the brush vertically tiles those areas that extend past its bitmap.
	SetExtendModeY(extendModeY) => ComCall(9, this, 'int', extendModeY, 'int')
	...
	SetInterpolationMode(interpolationMode) => ComCall(10, this, 'int', interpolationMode, 'int')
	...
	;
	; ID2D1Bitmap
	SetBitmap(bitmap) => ComCall(11, this, 'ptr', bitmap, 'int')
...
class ID2D1SolidColorBrush extends ID2D1Brush {
	...
	;
	; D2D1_COLOR_F
	SetColor(color) => ComCall(8, this, 'ptr', color, 'int')
...
class ID2D1LinearGradientBrush extends ID2D1Brush {
	...
	;
	; D2D1_POINT_2F
	SetStartPoint(startPoint) => ComCall(8, this, 'ptr', startPoint, 'int')

	; Sets the ending coordinates of the linear gradient in the brush's coordinate space.
	;
	; D2D1_POINT_2F
	SetEndPoint(endPoint) => ComCall(9, this, 'ptr', endPoint, 'int')
...
class ID2D1RadialGradientBrush extends ID2D1Brush {
	...
	GetRadiusX() => ComCall(14, this, 'float')

	; Retrieves the y-radius of the gradient ellipse.
	GetRadiusY() => ComCall(15, this, 'float')
...
class ID2D1GdiInteropRenderTarget extends ID2DBase {
	...
	; RECT_U
	ReleaseDC(update) => ComCall(4, this, 'ptr', update)
}
class ID2D1Geometry extends ID2D1Resource {
	...
	;
	; D2D1_MATRIX_3X2_F
	GetBounds(worldTransform := 0) {
		ComCall(4, this, 'ptr', worldTransform, 'ptr', bounds := D2D1_RECT_F())
		return bounds
	}

	; Gets the bounds of the geometry after it has been widened by the specified stroke width and style and transformed by the specified matrix.
	;
	; float, ID2D1StrokeStyle , D2D1_MATRIX_3X2_F, float
	GetWidenedBounds(strokeWidth, strokeStyle, worldTransform, flatteningTolerance) {
		ComCall(5, this, 'float', strokeWidth, 'ptr', strokeStyle, 'ptr', worldTransform, 'float', flatteningTolerance, 'ptr', bounds := D2D1_RECT_F())
		return bounds
	}
	...
	;
	; D2D1_POINT_2F, float, ID2D1StrokeStyle , D2D1_MATRIX_3X2_F, float
	...
	;
	; D2D1_POINT_2F , D2D1_MATRIX_3X2_F, float
	...
	;
	; D2D1_GEOMETRY_SIMPLIFICATION_OPTION , D2D1_MATRIX_3X2_F
	...
	;
	; ID2D1Geometry , D2D1_COMBINE_MODE , D2D1_MATRIX_3X2_F , ID2D1SimplifiedGeometrySink
	CombineWithGeometry(inputGeometry, combineMode, inputGeometryTransform, flatteningTolerance, geometrySink) => ComCall(11, this, 'ptr', inputGeometry, 'int', combineMode, 'ptr', inputGeometryTransform, 'float', flatteningTolerance, 'ptr', geometrySink)
	...
	;
	; float, D2D1_MATRIX_3X2_F, float
	ComputePointAtLength(length, worldTransform, flatteningTolerance, &point := 0, &unitTangentVector := 0) {
		ComCall(15, this, 'float', length, 'ptr', worldTransform, 'float', flatteningTolerance, 'ptr', point := D2D1_POINT_2F(), 'ptr', unitTangentVector := D2D1_POINT_2F())
	}
	...
	;
	; ID2D1StrokeStyle , D2D1_MATRIX_3X2_F
	Widen(strokeWidth, strokeStyle, worldTransform, flatteningTolerance, geometrySink) => ComCall(16, this, 'float', strokeWidth, 'ptr', strokeStyle, 'ptr', worldTransform, 'float', flatteningTolerance, 'ptr', geometrySink)
}
class ID2D1RectangleGeometry extends ID2D1Geometry {
	...
	GetRect() {
		ComCall(17, this, 'ptr', rect := D2D1_RECT_F(), 'int')
		return rect
	}
}
class ID2D1RoundedRectangleGeometry extends ID2D1Geometry {
	...
	GetRoundedRect() {
		ComCall(17, this, 'ptr', roundedRect := D2D1_ROUNDED_RECT(), 'int')
		return roundedRect
	}
}
class ID2D1EllipseGeometry extends ID2D1Geometry {
	...
	GetEllipse() {
		ComCall(17, this, 'ptr', ellipse := D2D1_ELLIPSE(), 'int')
		return ellipse
	}
}
class ID2D1GeometryGroup extends ID2D1Geometry {
	...
	;
	; D2D1_FILL_MODE
	GetFillMode() => ComCall(17, this, 'int')

	; Indicates the number of geometry objects in the geometry group.
	GetSourceGeometryCount() => ComCall(18, this, 'uint')
...
class ID2D1TransformedGeometry extends ID2D1Geometry {
	...
	GetTransform() {
		ComCall(18, this, 'ptr', transform := D2D1_MATRIX_3X2_F(), 'int')
		return transform
	}
}
class ID2D1PathGeometry extends ID2D1Geometry {
	...
	;
	; ID2D1GeometrySink
	Stream(geometrySink) => ComCall(18, this, 'ptr', geometrySink)
...
class ID2D1Bitmap extends ID2D1Resource {
	...
	GetSize() {
		ComCall(4, this, 'ptr', size := D2D1_SIZE_F(), 'int')
		return size
	}

	; Returns the size, in device-dependent units (pixels), of the bitmap.
	GetPixelSize() {
		ComCall(5, this, 'ptr', size := D2D1_SIZE_U(), 'int')
		return size
	}
	...
	;
	; D2D1_PIXEL_FORMAT
	GetPixelFormat() => ComCall(6, this, 'int')

	; Return the dots per inch (DPI) of the bitmap.
	GetDpi(&dpiX, &dpiY?) => ComCall(7, this, 'float*', &dpiX := 0, 'float*', &dpiY := 0, 'int')
	...
	;
	; D2D1_POINT_2U , ID2D1Bitmap , D2D1_RECT_U
	CopyFromBitmap(destPoint, bitmap, srcRect := 0) => ComCall(8, this, 'ptr', destPoint, 'ptr', bitmap, 'ptr', srcRect)
	...
	;
	; D2D1_POINT_2U , ID2D1RenderTarget , D2D1_RECT_U
	CopyFromRenderTarget(destPoint, renderTarget, srcRect := 0) => ComCall(9, this, 'ptr', destPoint, 'ptr', renderTarget, 'ptr', srcRect)
	...
	;
	; D2D1_RECT_U
	CopyFromMemory(dstRect, srcData, pitch) => ComCall(10, this, 'ptr', dstRect, 'ptr', srcData, 'uint', pitch)
}
class ID2D1GradientStopCollection extends ID2D1Resource {
	...
	GetGradientStopCount() => ComCall(4, this, 'uint')
	...
	GetGradientStops(gradientStopsCount) {
		ComCall(5, this, 'ptr', gradientStops := ctypes.array(D2D1_GRADIENT_STOP, gradientStopsCount)(), 'uint', gradientStopsCount, 'int')
	...
	;
	; D2D1_GAMMA
	GetColorInterpolationGamma() => ComCall(6, this, 'int')

	; Indicates the behavior of the gradient outside the normalized gradient range.
	;
	; D2D1_EXTEND_MODE
	GetExtendMode() => ComCall(7, this, 'int')
}
class ID2D1StrokeStyle extends ID2D1Resource {
	...
	;
	; D2D1_CAP_STYLE
	GetStartCap() => ComCall(4, this, 'int')

	; Retrieves the type of shape used at the end of a stroke.
	;
	; D2D1_CAP_STYLE
	GetEndCap() => ComCall(5, this, 'int')

	; Gets a value that specifies how the ends of each dash are drawn.
	;
	; D2D1_CAP_STYLE
	GetDashCap() => ComCall(6, this, 'int')

	; Retrieves the limit on the ratio of the miter length to half the stroke's thickness.
	GetMiterLimit() => ComCall(7, this, 'float')

	; Retrieves the type of joint used at the vertices of a shape's outline.
	;
	; D2D1_LINE_JOIN
	GetLineJoin() => ComCall(8, this, 'int')

	; Retrieves a value that specifies how far in the dash sequence the stroke will start.
	GetDashOffset() => ComCall(9, this, 'float')
	...
	;
	; D2D1_DASH_STYLE
	GetDashStyle() => ComCall(10, this, 'int')

	; Retrieves the number of entries in the dashes array.
	GetDashesCount() => ComCall(11, this, 'uint')
	...
	GetDashes(dashesCount) {
		ComCall(12, this, 'ptr', dashes := ctypes.array('float', dashesCount)(), 'uint', dashesCount, 'int')
		return dashes
	}
}
...
class ID2D1DrawingStateBlock extends ID2D1Resource {
	...
	GetDescription() {
		ComCall(4, this, 'ptr', stateDescription := D2D1_DRAWING_STATE_DESCRIPTION(), 'int')
	...
	SetDescription(stateDescription) => ComCall(5, this, 'ptr', stateDescription, 'int')

	; Specifies the text-rendering configuration of the drawing state.
	;
	; IDWriteRenderingParams
	SetTextRenderingParams(textRenderingParams := 0) => ComCall(6, this, 'ptr', textRenderingParams, 'int')
...
class ID2D1SimplifiedGeometrySink extends ID2DBase {
	...
	SetFillMode(fillMode) => ComCall(3, this, 'int', fillMode, 'int')

	; Specifies stroke and join options to be applied to segments added to the geometry sink.
	;
	; D2D1_PATH_SEGMENT
	SetSegmentFlags(vertexFlags) => ComCall(4, this, 'int', vertexFlags, 'int')
	...
	BeginFigure(startPoint, figureBegin) => ComCall(5, this, 'int64', NumGet(startPoint, 'int64'), 'int', figureBegin, 'int')

	; Creates a sequence of lines using the specified points and adds them to the geometry sink.
	;
	; D2D1_POINT_2F*
	AddLines(points, pointsCount) => ComCall(6, this, 'ptr', points, 'uint', pointsCount, 'int')

	; Creates a sequence of cubic Bezier curves and adds them to the geometry sink.
	;
	; D2D1_BEZIER_SEGMENT*
	AddBeziers(beziers, beziersCount) => ComCall(7, this, 'ptr', beziers, 'uint', beziersCount, 'int')

	; Ends the current figure; optionally, closes it.
	EndFigure(figureEnd) => ComCall(8, this, 'uint', figureEnd, 'int')

	; Closes the geometry sink, indicates whether it is in an error state, and resets the sink's error state.
	Close() => ComCall(9, this)
}
class ID2D1GeometrySink extends ID2D1SimplifiedGeometrySink {
	...
	;
	; D2D1_POINT_2F
	AddLine(point0, point1) => ComCall(10, this, 'float', point0, 'float', point1, 'int')

	; Creates a cubic Bezier curve between the current point and the specified endpoint.
	;
	; D2D1_BEZIER_SEGMENT
	AddBezier(bezier) => ComCall(11, this, 'ptr', bezier, 'int')

	; Creates a quadratic Bezier curve between the current point and the specified endpoint.
	;
	; D2D1_QUADRATIC_BEZIER_SEGMENT
	AddQuadraticBezier(bezier) => ComCall(12, this, 'ptr', bezier, 'int')

	; Adds a sequence of quadratic Bezier segments as an array in a single call.
	;
	; D2D1_QUADRATIC_BEZIER_SEGMENT
	AddQuadraticBeziers(beziers, beziersCount) => ComCall(13, this, 'ptr', beziers, 'uint', beziersCount, 'int')

	; Adds a single arc to the path geometry.
	;
	; D2D1_ARC_SEGMENT
	AddArc(arc) => ComCall(14, this, 'ptr', arc, 'int')
}
class ID2D1TessellationSink extends ID2DBase {
	...
	;
	; D2D1_TRIANGLE*
	AddTriangles(triangles, trianglesCount) => ComCall(3, this, 'ptr', triangles, 'uint', trianglesCount, 'int')

	; Closes the sink and returns its error status.
	Close() => ComCall(4, this)
}
...
class IDWriteFactory extends ID2DBase {
	...
	RegisterFontCollectionLoader(fontCollectionLoader) => ComCall(5, this, 'ptr', fontCollectionLoader)
	UnregisterFontCollectionLoader(fontCollectionLoader) => ComCall(6, this, 'ptr', fontCollectionLoader)
	...
	; float, float, float, DWRITE_PIXEL_GEOMETRY, DWRITE_RENDERING_MODE
	...
	RegisterFontFileLoader(fontFileLoader) => ComCall(13, this, 'ptr', fontFileLoader)
	; IDWriteFontFileLoader
	UnregisterFontFileLoader(fontFileLoader) => ComCall(14, this, 'ptr', fontFileLoader)
	; wstr, IDWriteFontCollection, DWRITE_FONT_WEIGHT, DWRITE_FONT_STYLE, DWRITE_FONT_STRETCH, float, wstr
	...
	CreateTypography() => (ComCall(16, this, 'ptr*', typography := IDWriteTypography()), typography)
	GetGdiInterop() => ComCall(17, this, 'ptr*', &gdiInterop := 0)
	; wstr, uint, IDWriteTextFormat, float, float
	CreateTextLayout(string, textFormat, maxWidth := 0, maxHeight := 0) {
...
class IDWriteBitmapRenderTarget extends ID2DBase {
	...
	DrawGlyphRun(baselineOriginX, baselineOriginY, measuringMode, glyphRun, renderingParams, textColor, &blackBoxRect := 0) => ComCall(3, this, 'float', baselineOriginX, 'float', baselineOriginY, 'int', measuringMode, 'ptr', glyphRun, 'ptr', renderingParams, 'uint', textColor, 'ptr', &blackBoxRect)
	GetMemoryDC() => ComCall(4, this, 'ptr')
	GetPixelsPerDip() => ComCall(5, this, 'float')
	SetPixelsPerDip(pixelsPerDip) => ComCall(6, this, 'float', pixelsPerDip)
	GetCurrentTransform() {
		ComCall(7, this, 'ptr', transform := DWRITE_MATRIX())
		return transform
	}
	SetCurrentTransform(transform) => ComCall(8, this, 'ptr', transform)
	GetSize() {
		ComCall(9, this, 'ptr', size := Buffer(8))
		return { cx: NumGet(size, 'int'), cy: NumGet(size, 4, 'int') }
	}
	Resize(width, height) => ComCall(10, this, 'uint', width, 'uint', height)
}
...
class IDWriteLocalFontFileLoader extends IDWriteFontFileLoader {
	...
	GetFilePathFromKey(fontFileReferenceKey, fontFileReferenceKeySize) {
		VarSetStrCapacity(&filePath, filePathSize := this.GetFilePathLengthFromKey(fontFileReferenceKey, fontFileReferenceKeySize) + 1)
...
class IDWriteLocalizedStrings extends ID2DBase {
	...
	FindLocaleName(localeName, &index, &exists) => ComCall(4, this, 'wstr', localeName, 'uint*', &index := 0, 'int*', &exists := 0)
	GetLocaleNameLength(index) {
		ComCall(5, this, 'uint', index, 'uint*', &length := 0)
		return length
	}
	GetLocaleName(index) {
		VarSetStrCapacity(&localeName, size := this.GetLocaleNameLength(index) + 1)
	...
	GetString(index) {
		VarSetStrCapacity(&stringBuffer, size := this.GetStringLength(index) + 1)
		ComCall(6, this, 'uint', index, 'wstr*', &stringBuffer, 'uint', size)
		return stringBuffer
	}
}
class IDWriteFontFileStream extends ID2DBase {
	static IID := '{6d4865fe-0ab8-4d91-8f62-5dd6be34a3e0}' ;todo
	ReadFileFragment(&fragmentStart, fileOffset, fragmentSize, &fragmentContext) => ComCall(3, this, 'ptr*', &fragmentStart := 0, 'int64', fileOffset, 'int64', fragmentSize, 'ptr*', &fragmentContext := 0)
	ReleaseFileFragment(fragmentContext) => ComCall(4, this, 'ptr', fragmentContext)
	GetFileSize() {
...
class IDWriteFontFile extends ID2DBase {
	...
	GetReferenceKey(&fontFileReferenceKey, &fontFileReferenceKeySize) => ComCall(3, this, 'ptr*', &fontFileReferenceKey := 0, 'uint*', &fontFileReferenceKeySize := 0)
	GetLoader() {
		ComCall(4, this, 'ptr*', &fontFileLoader := 0)
		return IDWriteFontFileLoader(fontFileLoader)
	}
	; BOOL, DWRITE_FONT_FILE_TYPE, DWRITE_FONT_FACE_TYPE, UINT
	Analyze(&isSupportedFontType, &fontFileType, &fontFaceType, &numberOfFaces) => ComCall(5, this, 'int*', &isSupportedFontType := 0, 'int*', &fontFileType := 0, 'int*', &fontFaceType := 0, 'uint*', &numberOfFaces := 0)
}
class IDWriteRenderingParams extends ID2DBase {
	static IID := '{2f0da53a-2add-47cd-82ee-d9ec34688e75}'
	GetGamma() => ComCall(3, this, 'float')
	GetEnhancedContrast() => ComCall(4, this, 'float')
	GetClearTypeLevel() => ComCall(5, this, 'float')
	; DWRITE_PIXEL_GEOMETRY
	GetPixelGeometry() => ComCall(6, this, 'int')
	; DWRITE_RENDERING_MODE
	GetRenderingMode() => ComCall(7, this, 'int')
}
class IDWriteFontFace extends ID2DBase {
	static IID := '{5f49804d-7024-4d43-bfa9-d25984f53849}'
	; DWRITE_FONT_FACE_TYPE
	GetType() => ComCall(3, this, 'int')
	; IDWriteFontFile[]
	GetFiles(&numberOfFiles, fontFiles) => ComCall(4, this, 'uint*', &numberOfFiles, 'ptr', fontFiles)
	GetIndex() => ComCall(5, this, 'uint')
	; DWRITE_FONT_SIMULATIONS
	GetSimulations() => ComCall(6, this, 'int')
	IsSymbolFont() => ComCall(7, this, 'int')
	GetMetrics() {
		ComCall(8, this, 'ptr', fontFaceMetrics := DWRITE_FONT_METRICS())
		return fontFaceMetrics
	}
	GetGlyphCount() => ComCall(9, this, 'ushort')
	; ushort[], uint, DWRITE_GLYPH_METRICS[]
	GetDesignGlyphMetrics(glyphIndices, glyphCount, isSideways := false) {
	...
	TryGetFontTable(openTypeTableTag, &tableData, &tableSize, &tableContext, &exists) => ComCall(12, this, 'uint', openTypeTableTag, 'ptr*', &tableData := 0, 'uint*', &tableSize := 0, 'ptr*', &tableContext := 0, 'int*', &exists := 0)
	ReleaseFontTable(tableContext) => ComCall(13, this, 'ptr', tableContext)
	; float, UINT16[], float, DWRITE_GLYPH_OFFSET, uint, BOOL, BOOL, IDWriteGeometrySink*
	GetGlyphRunOutline(emSize, glyphIndices, glyphAdvances, glyphOffsets, glyphCount, isSideways, isRightToLeft, geometrySink) => ComCall(14, this, 'float', emSize, 'ptr', glyphIndices, 'float', glyphAdvances, 'ptr', glyphOffsets, 'uint', glyphCount, 'int', isSideways, 'int', isRightToLeft, 'ptr', geometrySink)
	; float, float, DWRITE_MEASURING_MODE, IDWriteRenderingParams*
	...
	; float, float, DWRITE_MATRIX, BOOL, UINT16[], UINT, BOOL
	GetGdiCompatibleGlyphMetrics(emSize, pixelsPerDip, transform, useGdiNatural, glyphIndices, glyphCount, isSideways := false) {
...
class IDWriteFontFamily extends IDWriteFontList {
	...
	; DWRITE_FONT_WEIGHT, DWRITE_FONT_STRETCH, DWRITE_FONT_STYLE
...
class IDWriteTextFormat extends ID2DBase {
	...
	SetTextAlignment(textAlignment) => ComCall(3, this, 'int', textAlignment)
	; DWRITE_PARAGRAPH_ALIGNMENT
	SetParagraphAlignment(paragraphAlignment) => ComCall(4, this, 'int', paragraphAlignment)
	; DWRITE_WORD_WRAPPING
	SetWordWrapping(wordWrapping) => ComCall(5, this, 'int', wordWrapping)
	; DWRITE_READING_DIRECTION
	SetReadingDirection(readingDirection) => ComCall(6, this, 'int', readingDirection)
	; DWRITE_FLOW_DIRECTION
	SetFlowDirection(flowDirection) => ComCall(7, this, 'int', flowDirection)
	; float
	SetIncrementalTabStop(incrementalTabStop) => ComCall(8, this, 'float', incrementalTabStop)
	; DWRITE_TRIMMING, IDWriteInlineObject
	SetTrimming(trimmingOptions, trimmingSign) => ComCall(9, this, 'ptr', trimmingOptions, 'ptr', trimmingSign)
	; DWRITE_LINE_SPACING_METHOD, float, float
	SetLineSpacing(lineSpacingMethod, lineSpacing, baseline) => ComCall(10, this, 'int', lineSpacingMethod, 'float', lineSpacing, 'float', baseline)
	...
	GetLineSpacing(&lineSpacingMethod, &lineSpacing, &baseline) => ComCall(18, this, 'int*', &lineSpacingMethod := 0, 'float*', &lineSpacing := 0.0, 'float*', &baseline := 0.0)
	GetFontCollection() {
	...
	GetFontFamilyName() {
		VarSetStrCapacity(&fontFamilyName, nameSize := ComCall(20, this, 'uint') + 1)
	...
	GetLocaleName() {
		VarSetStrCapacity(&localeName, nameSize := ComCall(26, this, 'uint') + 1)
...
class IDWriteTextLayout extends IDWriteTextFormat {
	...
	; IDWriteFontCollection, DWRITE_TEXT_RANGE
	SetFontCollection(fontCollection, textRange) => ComCall(30, this, 'ptr', fontCollection, 'ptr', textRange)
	SetFontFamilyName(fontFamilyName, textRange) => ComCall(31, this, 'wstr', fontFamilyName, 'ptr', textRange)
	SetFontWeight(fontWeight, textRange) => ComCall(32, this, 'int', fontWeight, 'ptr', textRange)
	SetFontStyle(fontStyle, textRange) => ComCall(33, this, 'int', fontStyle, 'ptr', textRange)
	SetFontStretch(fontStretch, textRange) => ComCall(34, this, 'int', fontStretch, 'ptr', textRange)
	SetFontSize(fontSize, textRange) => ComCall(35, this, 'float', fontSize, 'ptr', textRange)
	SetUnderline(hasUnderline, textRange) => ComCall(36, this, 'int', hasUnderline, 'ptr', textRange)
	SetStrikethrough(hasStrikethrough, textRange) => ComCall(37, this, 'int', hasStrikethrough, 'ptr', textRange)
	; IUnknown, DWRITE_TEXT_RANGE
	SetDrawingEffect(drawingEffect, textRange) => ComCall(38, this, 'ptr', drawingEffect, 'ptr', textRange)
	; IDWriteInlineObject, DWRITE_TEXT_RANGE
	SetInlineObject(inlineObject, textRange) => ComCall(39, this, 'ptr', inlineObject, 'ptr', textRange)
	; IDWriteTypography, DWRITE_TEXT_RANGE
	SetTypography(typography, textRange) => ComCall(40, this, 'ptr', typography, 'ptr', textRange)
	SetLocaleName(localeName, textRange) => ComCall(41, this, 'ptr', localeName, 'ptr', textRange)
	...
	GetFontFamilyName(currentPosition, &textRange := 0) {
		VarSetStrCapacity(&fontFamilyName, nameSize := this.GetFontFamilyNameLength(currentPosition) + 1)
	...
	GetDrawingEffect(currentPosition, &textRange := 0) {
		ComCall(53, this, 'uint', currentPosition, 'ptr*', drawingEffect := ComValue(0xd, 0), 'ptr', textRange)
	...
	GetLocaleName(currentPosition, &textRange := 0) {
		VarSetStrCapacity(&localeName, nameSize := this.GetLocaleNameLength(currentPosition) + 1)
		ComCall(57, this, 'uint', currentPosition, 'wstr*', &localeName, 'uint', nameSize, 'ptr', textRange)
		return localeName
	}
	Draw(clientDrawingContext, renderer, originX, originY) => ComCall(58, this, 'ptr', clientDrawingContext, 'ptr', renderer, 'float', originX, 'float', originY)
	GetLineMetrics(lineMetrics, maxLineCount, &actualLineCount) => ComCall(59, this, 'ptr', lineMetrics, 'uint', maxLineCount, 'uint*', &actualLineCount := 0)
	GetMetrics() {
	...
	GetBreakConditions(&breakConditionBefore, &breakConditionAfter) => ComCall(62, this, 'int*', &breakConditionBefore := 0, 'int*', &breakConditionAfter)
}
...
class IDWriteTextRenderer extends IDWritePixelSnapping {
	...
	DrawGlyphRun(clientDrawingContext, baselineOriginX, baselineOriginY, measuringMode, glyphRun, glyphRunDescription, clientDrawingEffect) => ComCall(6, this, 'ptr', clientDrawingContext, 'float', baselineOriginX, 'float', baselineOriginY, 'int', measuringMode, 'ptr', glyphRun, 'ptr', glyphRunDescription, 'ptr', clientDrawingEffect)
	DrawUnderline(clientDrawingContext, baselineOriginX, baselineOriginY, measuringMode, glyphRun, glyphRunDescription, clientDrawingEffect) => ComCall(7, this, 'ptr', clientDrawingContext, 'float', baselineOriginX, 'float', baselineOriginY, 'int', measuringMode, 'ptr', glyphRun, 'ptr', glyphRunDescription, 'ptr', clientDrawingEffect)
	; DWRITE_STRIKETHROUGH
	DrawStrikethrough(clientDrawingContext, baselineOriginX, baselineOriginY, strikethrough, clientDrawingEffect) => ComCall(8, this, 'ptr', clientDrawingContext, 'float', baselineOriginX, 'float', baselineOriginY, 'ptr', strikethrough, 'ptr', clientDrawingEffect)
	; DWRITE_STRIKETHROUGH
	DrawInlineObject(clientDrawingContext, baselineOriginX, baselineOriginY, inlineObject, isSideways, isRightToLeft, clientDrawingEffect) => ComCall(9, this, 'ptr', clientDrawingContext, 'float', baselineOriginX, 'float', baselineOriginY, 'ptr', inlineObject, 'int', isSideways, 'int', isRightToLeft, 'ptr', clientDrawingEffect)
}
class IDWriteInlineObject extends ID2DBase {
	static IID := '{8339FDE3-106F-47ab-8373-1C6295EB10B3}'
	Draw(clientDrawingContext, renderer, originX, originY, isSideways, isRightToLeft, clientDrawingEffect) => ComCall(3, this, 'ptr', clientDrawingContext, 'ptr', renderer, 'float', originX, 'float', originY, 'int', isSideways, 'int', isRightToLeft, 'ptr', clientDrawingEffect)
	GetMetrics() {
...
class IDWriteTextAnalysisSink extends ID2DBase {
	...
	; uint, uint, DWRITE_SCRIPT_ANALYSIS
	SetScriptAnalysis(textPosition, textLength, scriptAnalysis) => ComCall(3, this, 'uint', textPosition, 'uint', textLength, 'ptr', scriptAnalysis)
	; uint, uint, DWRITE_LINE_BREAKPOINT
	SetLineBreakpoints(textPosition, textLength, lineBreakpoints) => ComCall(4, this, 'uint', textPosition, 'uint', textLength, 'ptr', lineBreakpoints)
	SetBidiLevel(textPosition, textLength, explicitLevel, resolvedLevel) => ComCall(5, this, 'uint', textPosition, 'uint', textLength, 'uchar', explicitLevel, 'uchar', resolvedLevel)
	; uint, uint, IDWriteNumberSubstitution
	SetNumberSubstitution(textPosition, textLength, numberSubstitution) => ComCall(6, this, 'uint', textPosition, 'uint', textLength, 'ptr', numberSubstitution)
}
class IDWriteTextAnalysisSource extends ID2DBase {
	...
	; DWRITE_READING_DIRECTION
	GetParagraphReadingDirection() => ComCall(5, this, 'int')
...
class IDWriteFont extends ID2DBase {
	...
	; DWRITE_FONT_WEIGHT
	GetWeight() => ComCall(4, this, 'int')
	; DWRITE_FONT_STRETCH
	GetStretch() => ComCall(5, this, 'int')
	; DWRITE_FONT_STYLE
	GetStyle() => ComCall(6, this, 'int')
	IsSymbolFont() => ComCall(7, this, 'int')
	GetFaceNames() {
	...
	GetInformationalStrings(informationalStringID, &exists) {
	...
	; DWRITE_FONT_SIMULATIONS
	GetSimulations() => ComCall(10, this, 'int')
	GetMetrics() {
...
class IDWriteGlyphRunAnalysis extends ID2DBase {
	...
	CreateAlphaTexture(textureType, textureBounds, alphaValues, bufferSize) => ComCall(4, this, 'int', textureType, 'ptr', textureBounds, 'ptr', alphaValues, 'uint', bufferSize)
	GetAlphaBlendParams(renderingParams, &blendGamma, &blendEnhancedContrast, &blendClearTypeLevel) => ComCall(5, this, 'ptr', renderingParams, 'float*', &blendGamma := 0.0, 'float*', &blendEnhancedContrast := 0.0, 'float*', &blendClearTypeLevel := 0.0)
}
class IDWriteTypography extends ID2DBase {
	static IID := '{55f1112b-1dc2-4b3c-9541-f46894ed85b6}'
	; DWRITE_FONT_FEATURE
	AddFontFeature(fontFeature) => ComCall(3, this, 'ptr', fontFeature)
...
class DWRITE_TEXT_RANGE extends ctypes.struct {
	static fields := [['uint', 'startPosition'], ['uint', 'length']]
}
